...
public class AutoPickupPermanentPattern extends ItemBehaviorPattern {

    public AutoPickupPermanentPattern(GamePanel gamePanel) {
        super(gamePanel);
    }
